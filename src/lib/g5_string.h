...
int g5_strcpy(const char *, const char *); // returns number of appends
int g5_strncpy(const char *, const char *, int); // returns number of appends
char *g5_strrev(const char *); // returns pointer to the original string (now reversed)
